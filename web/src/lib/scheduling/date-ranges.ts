...
export type OutOfOfficeEntry = {
  ...
  toUser?: { id: number; username: string | null; displayName: string | null } | null;
  reason?: string | null;
  emoji?: string | null;
  notes?: string | null;
...
/** Times are stored as the UTC hours and minutes of a Date, exactly as Cal.diy does. */
export type DateOverride = { date: Date | null; startTime: Date; endTime: Date };
export type WorkingHours = { days: number[]; startTime: Date; endTime: Date };
