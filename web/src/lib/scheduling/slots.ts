...
import type { DateRange, IOutOfOfficeData, OutOfOfficeEntry } from "./date-ranges";
import dayjs, { getTimeZone, type Dayjs } from "./dayjs";

type IFromUser = NonNullable<OutOfOfficeEntry["fromUser"]>;
type IToUser = NonNullable<OutOfOfficeEntry["toUser"]>;
