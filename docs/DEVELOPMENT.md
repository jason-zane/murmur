...
migrations, runs `supabase/tests/cloud-access.sql` and the OAuth/database tests with real
tokens, and leaves the stack up; `supabase stop` from the repository root stops it.
